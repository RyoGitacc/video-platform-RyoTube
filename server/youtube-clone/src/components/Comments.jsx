...
export default function Comments({videoId}) {
  ...
  useEffect(()=>{
    ...
    const fetchComments=async ()=>{
      try{
      const res=await axios.get(`https://simple-youtube.herokuapp.com/api/comments/${videoId}`);
  ...
  const commentSubmit=async()=>{
    try{
      const res = await axios.post('https://simple-youtube.herokuapp.com/api/comments',{videoId:videoId,desc:input,access_token:access_token});
