...
export default function Video() {
  ...
  useEffect(()=>{
    const fetchData =async()=>{
      try{
        const videoRes=await axios.get(`https://simple-youtube.herokuapp.com/api/videos/find/${path}`);
        const channelRes=await axios.get(`https://simple-youtube.herokuapp.com/api/users/find/${videoRes.data.userId}`);
  ...
  const handleLike=async()=>{
    await axios.put(`https://simple-youtube.herokuapp.com/api/users/like/${currentVideo._id}`,cookie);
    dispatch(like(currentUser._id))
  }

  const handleDislike=async()=>{
    await axios.put(`https://simple-youtube.herokuapp.com/api/users/dislike/${currentVideo._id}`,cookie)
    dispatch(dislike(currentUser._id))
  }

  const handleSub=async()=>{
    currentUser.subscribedUsers.includes(channel._id)?
    await axios.put(`https://simple-youtube.herokuapp.com/api/users/unsub/${channel._id}`,cookie) :
    await axios.put(`https://simple-youtube.herokuapp.com/api/users/sub/${channel._id}`,cookie)
